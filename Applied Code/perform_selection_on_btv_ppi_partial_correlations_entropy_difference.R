...
for(subject in 1:8){
  ...
  load(sprintf("./entropy_difference/subject_%s_entropy_difference.RData", subject))
  ...
  save(result, file = sprintf("./entropy_difference/subject_%s_entropy_difference_selection.RData", subject) )
}
